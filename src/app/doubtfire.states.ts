...
import {ProjectsRootComponent} from './projects/states/index/project.index';
import {UnitsRootComponent} from './units/states/index/unit.index';
...
const ProjectsRoot: NgHybridStateDeclaration = {
  name: 'projects2/index',
...
const ProjectsGroupState: NgHybridStateDeclaration = {
  name: 'projects2/groups',
  parent: 'projects2/index',
  url: '/projects2/:projectId/groups',
  views: {
    main: {
...
const UnitsRoot: NgHybridStateDeclaration = {
  name: 'units2/index',
  url: '/units2/:unitId',
  resolve: {
    unitId: [
...
const UnitGroupsState: NgHybridStateDeclaration = {
  name: 'students/groups',
  parent: 'units2/index',
  url: '/units/:unitId/students/groups',
  views: {
    main: {
      component: UnitGroupsComponent,
    },
